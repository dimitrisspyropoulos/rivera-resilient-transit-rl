# Multi-Objective Resilient Urban Network Design & Disruption Management under Budget Constraints

**A Reinforcement Learning Framework for the Case of Rivera, Uruguay**
...
```
B_design = max(C₀, C₀ · (1 + p) · (1 − ρ))        ρ = 0.05
```
